...
def meteor_calc_dist(lat1,lon1,lat2,lon2):
    ...
    return 6372.8 * 2 * math.asin(math.sqrt(haversine))


    def get_dist(meteor):
        return meteor.get('distance',math.inf)

        my_loc=(40.05789329372498,-75.38379549980164)
        ...
        for meteor in meteor_data:
            ...
            meteor['distance'] = meteor_calc_dist(float(meteor['reclat']),
